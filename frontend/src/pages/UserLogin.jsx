    ...
    >
          ...
          <div className="space-y-6">
            ...
            <div className="group">
              ...
              <input
                ...
                placeholder="hasta@aesthemirage.com"
                type="email"
                value={email}
      ...
      >
        ...
        <div className="absolute inset-0 z-0">
          <img
            alt="Aesthemirage beauty clinic"
        ...
        <div className="relative z-10 max-w-xl px-12 text-center md:text-left space-y-10">
          <div className="space-y-6">
            ...
            <p
              ...
              style={{ color: colors.textSecondary }}
            >
              Türkiye'nin en seçkin estetik hizmetlerini keşfedin. Güvenilir
              klinikler, deneyimli doktorlar ve özel fiyatlandırmayla siz de
              güzelliğinizi yenileyin.
            </p>
          </div>
        ...
        >
          ...
          <div>
            ...
            <p
              ...
              style={{ color: colors.textSecondary }}
            >
              20.000+ seçkin üye ile birlikte olun.
            </p>
          </div>
        </div>
      </section>
