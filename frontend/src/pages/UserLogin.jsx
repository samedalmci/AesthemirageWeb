          ...
          <form className="space-y-8" onSubmit={handleSubmit}>
            <div className="space-y-6">
              ...
              <div className="group">
                ...
                <input
                  type="email"
                  placeholder="example@aesthemirage.com"
                  value={email}
          ...
          >
            ...
            <div className="space-y-6">
              <h2
                ...
                style={{ color: colors.text }}
              >
                Aesthemirage Dünyasına
                <br />
                <span style={{ color: colors.accent }}>Hoş Geldiniz</span>
              </h2>
              <p
                className="text-lg font-light leading-relaxed max-w-lg"
                style={{ color: colors.textSecondary }}
              >
                Kişiselleştirilmiş estetik yolculuğunuza başlayın, favori
                doktorlarınızı kaydedin ve randevularınızı yönetin.
              </p>
            </div>
